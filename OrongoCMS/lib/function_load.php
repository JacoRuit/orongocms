...
function load($paramLibFolder){
    ...
    $orongo_classes = array('AjaxAction' ,'CommentPoster', 'CommentLoader', 'Article', 'Cache', 'Comment', 'Database', 'Display', 'Image','Issue', 'IssueTracker', 'Mail', 'MailFactory', 'Menu', 'MessageBox', 'OrongoEvent', 'OrongoEventManager', 'OrongoNotifier', 'OrongoNotification', 'OrongoQuery', 'OrongoQueryHandler', 'OrongoTerminal', 'Page', 'Plugin', 'Security', 'Session', 'Settings', 'Storage', 'Style', 'User');
